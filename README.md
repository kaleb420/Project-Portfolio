...
This is the first time I had to work in a group for a project, and many difficulties were encountered within this project pertaining to the groupwork aspect. Firstly, one person was essentially the director of this project. But there were a plethora of communication issues. There was a lack of comments, functions were included in the repository but never used, along with a general lack of direction. If this project were to be done again, prioritizing communication is a must, assigning tasks, and letting the code be readable and understandable.
